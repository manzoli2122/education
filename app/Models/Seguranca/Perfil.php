...
{    
    ...
    {
        return $this->belongsToMany( 'App\Models\Seguranca\Permissao', 'permissao_perfils', 'perfil_id', 'permissao_id');
    }
    ...
    public static function boot()
    {
        ...
        static::deleting(function ($perfil) {
            if (!method_exists( 'App\Models\Seguranca\Perfil' , 'bootSoftDeletes')) {
